				...
				<div class="new-pass__inner block">
					...
					<form action="#" method="" class="new-pass__form">
						<label class="new-pass__form-label">
							...
							<img src="../assets/login/cross.svg" alt="New-pass cross" class="new-pass__cross" />
							<div class="new-pass__eyeClose-button">
								<img src="../assets/login/close-eye.svg" alt="New-pass closeEye" class="new-pass__eyeClose" />
						...
						<div class="new-pass__validation validation">
							<div class="new-pass__min validation__item">
								<img src="../assets/new.password/tick.svg" alt="New password tick" class="new-pass__tick validation__tick validation__hidden" />
